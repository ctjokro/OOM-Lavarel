...
!function(e){
    ...
    function a(e){
        return/^(video|application)/i.test(e)||(e=i(e)),!!h.canPlayType(e).replace("no","")
    }
    function o(t,n){
    ...
    function r(e){
        ...
        return n=/mpegurl/i.test(n)?"mpegurl":n.replace("video/",""),{
            src:t,
            suffix:i||n,
            type:n||i
        }
    ...
    e.fn.flowplayer=function(t,n){
        return"string"==typeof t&&(t={
            ...
            if(r.playlist.length){
                var v,g=r.preload||l.attr("preload");
                l.length&&l.replaceWith(v=e("<p />")),l=e("<video />").addClass("fp-engine"),v?v.replaceWith(l):o.prepend(l),flowplayer.support.video&&l.attr("preload",g),"string"==typeof r.playlist[0]?l.attr("src",r.playlist[0]):e.each(r.playlist[0],function(t,n){
            ...
            var h=o.data("flowplayer");
            h&&h.unload(),o.data("fp-player_id",o.data("fp-player_id")||m++);
            try{
                f=p?window.localStorage:f
            }catch(y){}
            ...
            var w=h||{
                ...
                rtl:b,
                load:function(t,n){
                    if(!(w.error||w.loading||w.disabled)){
                        if(t=d.resolve(t),e.extend(t,a.pick(t.sources)),t.src){
                            var i=e.Event("load");
                            o.trigger(i,[w,t,a]),i.isDefaultPrevented()?w.loading=!1:(a.load(t),e.isFunction(t)&&(n=t),n&&o.one("ready",n))
                        }
                        return w
                    }
                },
                pause:function(e){
                    return!w.ready||w.seeking||w.disabled||w.loading||(a.pause(),w.one("pause",e)),w
                },
                resume:function(){
                    return w.ready&&w.paused&&!w.disabled&&(a.resume(),w.finished&&(w.trigger("resume",[w]),w.finished=!1)),w
                },
                toggle:function(){
                    return w.ready?w.paused?w.resume():w.pause():w.load()
                },
                seek:function(t,n){
                    if(w.ready){
                        if("boolean"==typeof t){
                            var r=.1*w.video.duration;
                            t=w.video.time+(t?r:-r)
                        }
                        t=i=Math.min(Math.max(t,0),w.video.duration).toFixed(1);
                        var s=e.Event("beforeseek");
                        o.trigger(s,[w,t]),s.isDefaultPrevented()?(w.seeking=!1,o.toggleClass("is-seeking",w.seeking)):(a.seek(t),e.isFunction(n)&&o.one("seek",n))
                    }
                    return w
                },
                seekTo:function(e,t){
                    var n=void 0===e?i:.1*w.video.duration*e;
                    return w.seek(n,t)
                },
                mute:function(e){
                    return void 0===e&&(e=!w.muted),f.muted=w.muted=e,f.volume=isNaN(f.volume)?r.volume:f.volume,w.volume(e?0:f.volume,!0),w.trigger("mute",e),w
                },
                volume:function(e,t){
                    return w.ready&&(e=Math.min(Math.max(e,0),1),t||(f.volume=e),a.volume(e)),w
                },
                speed:function(t,n){
                    return w.ready&&("boolean"==typeof t&&(t=r.speeds[e.inArray(w.currentSpeed,r.speeds)+(t?1:-1)]||w.currentSpeed),a.speed(t),n&&o.one("speed",n)),w
                },
                stop:function(){
                    return w.ready&&(w.pause(),w.seek(0,function(){
                        o.trigger("stop")
                    })),w
                },
                unload:function(){
                    return o.hasClass("is-embedding")||(r.splash?(w.trigger("unload"),a.unload()):w.stop()),w
                },
                disable:function(e){
                    return void 0===e&&(e=!w.disabled),e!=w.disabled&&(w.disabled=e,w.trigger("disable",e)),w
                }
            };
    
            w.conf=e.extend(w.conf,r),e.each(["bind","one","unbind"],function(e,t){
                w[t]=function(e,n){
                    return o[t](e,n),w
                }
            }),w.trigger=function(e,t){
                return o.trigger(e,[w,t]),w
            },o.data("flowplayer")||o.bind("boot",function(){
                return e.each(["autoplay","loop","preload","poster"],function(e,t){
                    var n=l.attr(t);
                    void 0!==n&&(r[t]=n?n:!0)
                }),(r.splash||o.hasClass("is-splash")||!flowplayer.support.firstframe)&&(w.forcedSplash=!r.splash&&!o.hasClass("is-splash"),w.splash=r.splash=r.autoplay=!0,o.addClass("is-splash"),flowplayer.support.video&&l.attr("preload","none")),(r.live||o.hasClass("is-live"))&&(w.live=r.live=!0,o.addClass("is-live")),e.each(c,function(){
                    this(w,o)
                }),a=flowplayer.engine[r.engine],a&&(a=a(w,o)),a.pick(d.initialSources)?w.engine=r.engine:e.each(flowplayer.engine,function(e){
                    return e!=r.engine&&(a=this(w,o),a.pick(d.initialSources))?(w.engine=e,!1):void 0
                }),u.push(w),w.engine?(r.splash?w.unload():w.load(),r.disabled&&w.disable(),a.volume(w.volumeLevel),o.one("ready",n),void 0):w.trigger("error",{
                ...
                r.splash&&l.remove(),o.removeClass("is-loading"),w.loading=!1
            }).bind("ready unload",function(e){
                var t="ready"==e.type;
                o.toggleClass("is-splash",!t).toggleClass("is-ready",t),w.ready=t,w.splash=!t
                ...
                w.seeking="beforeseek"==e.type,o.toggleClass("is-seeking",w.seeking)
            }).bind("ready pause resume unload finish stop",function(e,t,n){
                w.paused=/pause|finish|unload|stop/.test(e.type),"ready"==e.type&&(w.paused="none"==r.preload,n&&(w.paused=!n.duration||!r.autoplay&&"none"!=r.preload)),w.playing=!w.paused,o.toggleClass("is-paused",w.paused).toggleClass("is-playing",w.playing),w.load.ed||w.pause()
            }).bind("finish",function(){
                w.finished=!0
            }).bind("error",function(){
                l.remove()
            }),o.trigger("boot",[w,o]).data("flowplayer",w)
        })
    },!function(){
        var t=function(e){
            var t=/Version\/(\d\.\d)/.exec(e);
            return t&&t.length>1?parseFloat(t[1],10):0
        },n=flowplayer.support,i=e.browser,a=e("<video loop autoplay preload/>")[0],o=navigator.userAgent,r=i.msie||/Trident\/7/.test(o),s=/iPad|MeeGo/.test(o)&&!/CriOS/.test(o),l=/iPad/.test(o)&&/CriOS/.test(o),d=/iP(hone|od)/i.test(o)&&!/iPad/.test(o),u=/Android/.test(o)&&!/Firefox/.test(o),c=/Android/.test(o)&&/Firefox/.test(o),f=/Silk/.test(o),p=/IEMobile/.test(o),v=(s?t(o):0,u?parseFloat(/Android\ (\d\.\d)/.exec(o)[1],10):0);
        e.extend(n,{
            subtitles:!!a.addTextTrack,
            fullscreen:"function"==typeof document.webkitCancelFullScreen&&!/Mac OS X 10_5.+Version\/5\.0\.\d Safari/.test(o)||document.mozFullScreenEnabled||"function"==typeof document.exitFullscreen||"function"==typeof document.msExitFullscreen,
            ...
            hlsDuration:!u&&(!i.safari||s||d||l),
            seekable:!s&&!l
        });
        try{
            var m=navigator.plugins["Shockwave Flash"],g=r?new ActiveXObject("ShockwaveFlash.ShockwaveFlash").GetVariable("$version"):m.description;
            r||m[0].enabledPlugin?(g=g.split(/\D+/),g.length&&!g[0]&&(g=g.slice(1)),n.flashVideo=g[0]>9||9==g[0]&&g[3]>=115):n.flashVideo=!1
        }catch(h){}
        try{
        ...
        var a,o,r,s=n.conf;
        n.video;
        var l=e(window),d=function(){
            if("webkit"==S||D){
                var t=e("object param[name='flashvars']",i),a=(t.attr("value")||"").split("&");
                e.each(a,function(e,i){
                    return i=i.split("="),"url"==i[0]&&i[1]!=n.video.url?(a[e]="url="+n.video.url,t.attr({
                        value:a.join("&")
                    }),!1):void 0
                })
            }
            ...
            if(n.conf.flashfit||/full/.test(t.type)){
                var r,s,d=n.isFullscreen,u=d&&_,c=!flowplayer.support.inlineBlock,f=d?u?screen.width:l.width():o,p=d?u?screen.height:l.height():a,v=0,m=0,g=c?o:"",h=c?a:"";
                (n.conf.flashfit||"fullscreen"===t.type)&&(r=n.video.width/n.video.height,s=n.video.height/n.video.width,h=Math.max(s*f),g=Math.max(r*p),h=h>p?g*s:h,h=Math.min(Math.round(h),p),g=g>f?h*r:g,g=Math.min(Math.round(g),f),m=Math.max(Math.round((p+m-h)/2),0),v=Math.max(Math.round((f+v-g)/2),0)),e("object",i).css({
                    width:g,
                    height:h,
                    marginTop:m,
                    marginLeft:v
            ...
            pick:function(t){
                if(flowplayer.support.flashVideo){
                    ...
                    if(n)return n;
                    for(var i,a=0;a<t.length;a++)if(i=t[a],/mp4|flv/i.test(i.type))return i
                }
            },
            load:function(l){
                function c(e){
                ...
                var f=e("video",i),p=c(l.src);
                is_absolute=/^https?:/.test(p);
                var v=function(){
                    f.remove()
                },m=function(t){
                    return e.grep(t,function(e){
                        return!!f[0].canPlayType("video/"+e.type)
                    }).length>0
                };
        
                if(flowplayer.support.video&&f.prop("autoplay")&&m(l.sources)?f.one("timeupdate",v):v(),is_absolute||s.rtmp||(p=e("<img/>").attr("src",p)[0].src),r)r.__play(p);
                else{
                    n.bind("ready",d).bind("ready fullscreen fullscreen-exit",u),a="fp"+(""+Math.random()).slice(3,15);
                    var g={
                    ...
                    i.data("origin")&&(g.origin=i.data("origin")),is_absolute&&delete s.rtmp,e.each(["key","autoplay","preload","rtmp","subscribe","live","loop","debug","splash"],function(e,t){
                        s[t]&&(g[t]=s[t])
                    }),void 0!==s.bufferTime&&(g.bufferTime=s.bufferTime),g.rtmp&&(g.rtmp=c(g.rtmp),g.live&&(g.preload="none")),o=t(s.swf,g),o.prependTo(i),r=o[0],setTimeout(function(){
                        try{
            ...
            speed:e.noop,
            unload:function(){
                r&&r.__unload&&r.__unload(),delete e[a],e("object",i).remove(),r=0,n.unbind("ready",d).unbind("ready fullscreen fullscreen-exit",u)
            }
        };

        return e.each("pause,resume,seek,volume".split(","),function(e,t){
            c[t]=function(e){
                try{
    ...
    flowplayer.engine.html5=function(t,r){
        function s(o,s,l){
            o.listeners&&o.listeners.hasOwnProperty(r.data("fp-player_id"))||((o.listeners||(o.listeners={}))[r.data("fp-player_id")]=!0,s.bind("error",function(n){
                try{
            ...
            }),e.each(y,function(a,s){
                o.addEventListener(a,function(u){
                    if("progress"==s&&u.srcElement&&0===u.srcElement.readyState&&setTimeout(function(){
                        t.video.duration||t.conf.live&&("mpegurl"!==t.video.type||!p.hlsDuration)||(s="error",t.trigger(s,{
                            code:4
                        }))
                    },1e4),m.debug&&!/progress/.test(s)&&console.log(a,"->",s,u),(t.ready||/ready|error/.test(s))&&s&&e("video",r).length){
                        var c,f,v=e.Event(s);
                        switch(s){
                            case"ready":
                                c=e.extend(l,{
                                ...
                                try{
                                    f=i(e("video",r).attr("type")),c.seekable=!m.live&&/mpegurl/i.test(f)&&o.duration||o.seekable&&o.seekable.end(null)
                                }catch(g){}
                                if(d=d||setInterval(function(){
                                    try{
                                        c.buffer=o.buffered.end(null)
                                    }catch(e){}
                                    c.buffer&&(n(c.buffer,1e3)<n(c.duration,1e3)&&!c.buffered?t.trigger("buffer",u):c.buffered||(c.buffered=!0,t.trigger("buffer",u).trigger("buffered",u),clearInterval(d),d=0))
                                },250),!m.live&&!c.duration&&!p.hlsDuration&&"loadeddata"===a){
                                    var h=function(){
                                        c.duration=o.duration;
                                        try{
                                            c.seekable=o.seekable&&o.seekable.end(null)
                                        }catch(e){}
                                        t.trigger(v,c),o.removeEventListener("durationchange",h)
                                    };
                                
                                    return o.addEventListener("durationchange",h),void 0
                                }
                                break;
                            case"progress":case"seek":
                                if(t.video.duration,o.currentTime>0){
                                    c=Math.max(o.currentTime,0);
                                    break
                                }
                                if("progress"==s)return;case"speed":
                                c=n(o.playbackRate);
                                break;
                            case"volume":
                                c=n(o.volume);
                            ...
                            case"error":
                                try{
                                    c=(u.srcElement||u.originalTarget).error
                                }catch(y){
                                    return
                                }
                        }
        ...
        var l,d,u,c,f=e("video",r),p=flowplayer.support,v=e("track",f),m=t.conf;
        return l={
            pick:function(e){
                if(p.video){
                    if(m.videoTypePreference){
                        var t=o(e,m.videoTypePreference);
                        if(t)return t
                    }
            ...
            load:function(n){
                if(m.splash&&!u)f=b(n).prependTo(r),p.inlineVideo||f.css({
                    position:"absolute",
                    top:"-9999em"
                }),v.length&&f.append(v.attr("default","")),m.loop&&f.attr("loop","loop"),u=f[0],"undefined"!=typeof c&&(u.volume=c);
                else{
                    u=f[0];
                    var i=f.find("source");
                    !u.src&&i.length&&(u.src=n.src,i.remove()),t.video.src&&n.src!=t.video.src?(f.attr("autoplay","autoplay"),u.src=n.src):"none"!=m.preload&&p.dataload||(p.zeropreload?t.trigger("ready",n).trigger("pause").one("ready",function(){
                        r.trigger("resume",[t])
                    }):t.one("ready",function(){
                        r.trigger("pause",[t])
                    }))
                }
                s(u,e("source",f).add(f),n),("none"!=m.preload&&"mpegurl"!=n.type||!p.zeropreload||!p.dataload)&&u.load(),m.splash&&u.load()
            },
            pause:function(){
                u.pause()
            },
            ...
            unload:function(){
                e("video.fp-engine",r).remove(),p.cachedVideoTag||(g=null),d=clearInterval(d),u=0
            }
        }
    };
    ...
    e.throttle=function(e,t){
        ...
        var u=i("progress"),c=i("buffer"),f=i("elapsed"),p=i("remaining"),v=i("waiting"),m=i("ratio"),g=i("speed"),h=i("duration"),y=m.css("paddingTop"),b=i("timeline").slider2(t.rtl),w=b.data("api"),k=(i("volume"),i("fullscreen")),x=i("volumeslider").slider2(t.rtl),C=x.data("api"),T=n.is(".fixed-controls, .no-toggle");
        ...
        t.bind("ready",function(){
            ...
            t.preventDefault();
            var i=n.offset(),a=e(window),o=t.clientX-i.left,r=t.clientY-i.top+a.scrollTop(),s=n.find(".fp-context-menu").css({
                left:o+"px",
                top:r+"px",
                display:"block"
            }).on("click",function(e){
        ...
        var F=n.css("backgroundColor"),E="none"!=n.css("backgroundImage")||F&&"rgba(0, 0, 0, 0)"!=F&&"transparent"!=F;
        !E||s.splash||s.autoplay||t.bind("ready stop",function(){
            n.addClass("is-poster").one("progress",function(){
                n.removeClass("is-poster")
            })
        }),!E&&t.forcedSplash&&n.css("backgroundColor","#555"),e(".fp-toggle, .fp-play",n).click(t.toggle),e.each(["mute","fullscreen","unload"],function(e,n){
            i(n).click(function(){
                t[n]()
            })
    ...
    var T,S=e.browser.mozilla?"moz":"webkit",F="fullscreen",E="fullscreen-exit",_=flowplayer.support.fullscreen,M=("function"==typeof document.exitFullscreen,navigator.userAgent.toLowerCase()),D=/(safari)[ \/]([\w.]+)/.exec(M)&&!/(chrome)[ \/]([\w.]+)/.exec(M);
    e(document).bind("fullscreenchange webkitfullscreenchange mozfullscreenchange MSFullscreenChange",function(t){
        var n=e(document.webkitCurrentFullScreenElement||document.mozFullScreenElement||document.fullscreenElement||document.msFullscreenElement||t.target);
        n.length&&!T?T=n.trigger(F,[n]):(T.trigger(E,[T]),T=null)
    }),flowplayer(function(t,n){
        if(t.conf.fullscreen){
            ...
            t.isFullscreen=!1,t.fullscreen=function(r){
                if(!t.disabled){
                    if(void 0===r&&(r=!t.isFullscreen),r&&(i=a.scrollTop()),"webkit"!=S&&!D||"flash"!=t.engine||(o={
                        apply:!0,
                        pos:t.video.time,
                        play:t.playing
                    }),_)if(r){
                        var s=n[0];
                        e.each(["requestFullScreen","webkitRequestFullScreen","mozRequestFullScreen","msRequestFullscreen"],function(e,t){
                            return"function"==typeof s[t]?(s[t](Element.ALLOW_KEYBOARD_INPUT),!D||document.webkitCurrentFullScreenElement||document.mozFullScreenElement||s[t](),!1):void 0
                        })
                    }else e.each(["exitFullscreen","webkitCancelFullScreen","mozCancelFullScreen","msExitFullscreen"],function(e,t){
                        return"function"==typeof document[t]?(document[t](),!1):void 0
                    });else t.trigger(r?F:E,[t]);
                    return t
                }
            };
            ...
            n.bind("mousedown.fs",function(){
                ...
                var e;
                _||"html5"!==t.engine||(e=n.css("opacity")||"",n.css("opacity",0)),n.removeClass("is-fullscreen"),_||"html5"!==t.engine||setTimeout(function(){
                    n.css("opacity",e)
                }),t.isFullscreen=!1,a.scrollTop(i)
            }).bind("ready",function(){
                if(o.apply){
                    var n=function(){
                        o.play||t.conf.live||t.pause(),e.extend(o,{
                            pos:0,
                            play:!1
                        })
                    };
                
                    t.conf.live?(t.resume(),n()):t.conf.rtmp&&o.pos&&!isNaN(o.pos)?t.seek(o.pos,n):n()
                }
            })
        }
    }),flowplayer(function(t,n){
    ...
    flowplayer(function(t,n){
        function i(e){
            n[0].className=n[0].className.replace(A," "),e>=0&&n.addClass("cue"+e)
        }
        var a=0;
        ...
        if(!flowplayer.support.subtitles||(t.subtitles=a.length&&a[0].track,!o.nativesubtitles||"html5"!=o.engine)){
            a.remove();
            var r=/^(([0-9]{2}:){1,2}[0-9]{2}[,.][0-9]{3}) --\> (([0-9]{2}:){1,2}[0-9]{2}[,.][0-9]{3})(.*)/;
            t.subtitles=[];
            var s=a.attr("src");
            if(s){
                setTimeout(function(){
    ...
    (flowplayer.support.touch||P)&&flowplayer(function(t,n){
        ...
        n.bind("touchmove",function(){
            ...
            return s?(s=!1,void 0):t.playing&&!n.hasClass("is-mouseover")?(n.addClass("is-mouseover").removeClass("is-mouseout"),!1):(t.paused&&n.hasClass("is-mouseout")&&!t.splash&&t.toggle(),t.paused&&P&&e("video.fp-engine",n)[0].play(),void 0)
        ...
        if(t.conf.embed!==!1){
            var i=t.conf,a=e(".fp-ui",n),o=e("<a/>",{
                "class":"fp-embed",
                title:"Copy to your site"
            }).appendTo(a),r=e("<div/>",{
                "class":"fp-embed-code"
            }).append("<label>Paste this HTML code on your site to embed.</label><textarea/>").appendTo(a),s=e("textarea",r);
            t.embedCode=function(){
                var a=t.video,o=a.width||n.width(),r=a.height||n.height(),s=e("<div/>",{
                    "class":"flowplayer",
                    css:{
                        width:o,
                        height:r
                ...
                e.each(["origin","analytics","key","rtmp","subscribe","bufferTime"],function(e,t){
                    i.hasOwnProperty(t)&&s.attr("data-"+t,i[t])
                    ...
                    (!/^https?:/.test(n.src)&&"flash"!==n.type||!i.rtmp)&&(a=e("<img/>").attr("src",n.src)[0].src),l.append(e("<source/>",{
                        type:"mpegurl"!=n.type?"video/"+n.type:"application/x-mpegurl",
                        src:a
                    }))
                });
                var d={
                    src:"//embed.flowplayer.org/5.5.0/embed.min.js"
                };
...
flowplayer(function(e,o){
    ...
    if("file:"==location.protocol&&(n="localhost"),e.load.ed=1,r.hostname=n,r.origin=i||location.href,i&&o.addClass("is-embedded"),"string"==typeof t&&(t=t.split(/,\s*/)),t&&"function"==typeof key_check&&key_check(t,n))r.logo&&o.append(a("<a>",{
        ...
        a(".fp-controls",o);
        var p=a('<div class="fp-context-menu"><ul><li class="copyright">&copy; 2014</li><li><a href="http://flowplayer.org">About Flowplayer</a></li><li><a href="http://flowplayer.org/license">GPL based license</a></li></ul></div>').appendTo(o);
