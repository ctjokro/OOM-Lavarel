@section('title', 'Administrator :: '.TITLE_FOR_PAGES.'Cities List')
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul id="breadcrumb" class="breadcrumb">
                    ...
                    <li>
                        <i class="fa fa-building-o"></i> Cities </li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::open(array('url' => 'admin/cities/admin_index', 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>'form-inline')) }}
                        ...
                        <span class="hint" style="margin:5px 0">Search Cities by typing their name</span>
                        <!--                        <div class="form-group align_box">
                                                    <div class="clr"></div>
