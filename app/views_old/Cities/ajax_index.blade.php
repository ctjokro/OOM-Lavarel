...
if (!$cities->isEmpty()) {
    ...
    {{ Form::open(array('url' => 'admin/cities/admin_index', 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>"form-inline form")) }}
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                                ...
                                foreach ($cities as $city) {
                                    ...
                                    <tr>
                                        <td data-title="Select">
                                            <?php if($city->id!='1') { ?>
                                            {{ Form::checkbox('id', $city->id,null, array("onclick"=>"javascript:isAllSelect(this.form);",'name'=>"chkRecordId[]")) }}
                                            <?php } ?>
                                        </td>
                                        <td data-title="Name">
                                            {{ ucwords($city->name); }}
                                        ...
                                        <td data-title="Created">
                                            {{  date("d M, Y h:i A", strtotime($city->created)) }}</td>
    ...
    <!--                    Number of Citys <span class="badge-gray"> </span> - <span class="badge-gray"> </span> out of <span class="badge-gray"></span>-->
                    ...
                    <div class="dataTables_paginate paging_bootstrap pagination">
                        {{ $cities->appends(Request::only('search','from_date','to_date'))->links() }}
                    </div>
                </div>
                <div class="panel-body">
