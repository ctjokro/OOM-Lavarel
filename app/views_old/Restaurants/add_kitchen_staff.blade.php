            ...
            <div class="acc_bar acc_bar_new">
                ...
                <div class="informetion informetion_new">
                    <div class="informetion_top">
                        <div class="tatils">Add New Kitchen Staff</div>
                        <div class="pery">
                            ...
                            {{ Form::open(array('url' => '/user/addkitchenstaff', 'method' => 'post', 'id' => 'myform', 'files' => true,'class'=>"cmxform form-horizontal tasi-form form")) }}
...
<!--<div class="btnt">
                            ...
                            <div class="multiple-fields">
                                ...
                                <div class="form_group">
                                    ...
                                    <div class="form_group_left form_group_right">
                                        {{ HTML::decode(Form::label('last_name', "Contact No. <span class='require'>*</span>",array('class'=>"control-label col-lg-2"))) }}
                                        <div class="in_upt">
