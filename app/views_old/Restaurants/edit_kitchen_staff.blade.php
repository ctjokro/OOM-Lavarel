            ...
            <div class="acc_bar acc_bar_new">
                ...
                <div class="informetion informetion_new">
                    <div class="informetion_top">
                        <div class="tatils">Edit Kitchen Staff Details</div>
                        <div class="pery">
                            ...
                            {{ Form::model($detail, array('url' => '/user/editkitchenstaff/'.$detail->slug, 'method' => 'post', 'id' => 'myform', 'files' => true,'class'=>"cmxform form-horizontal tasi-form form")) }}
                            ...
                            <div class="multiple-fields">
                                ...
                                <div class="form_group">
                                    ...
                                    <div class="form_group_left form_group_right">
                                        {{ HTML::decode(Form::label('contact', "Contact No. <span class='require'>*</span>",array('class'=>"control-label col-lg-2"))) }}
                                        <div class="in_upt">
                                            {{  Form::text('contact', Input::old('contact'),  array('minlength' => 6, 'maxlength' => 16,  'class' => 'required form-control','id'=>"contact"))}}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form_group form_groupse">
                                    ...
                                    <div class="in_upt in_upt_res">
                                        ...
                                        {{ html_entity_decode(HTML::link(HTTP_PATH.'user/kitchenstaff', "Cancel", array('class' => 'btn btn-default'), true)) }}
                                    </div>
                                </div>
                            </div>
                        </div>
