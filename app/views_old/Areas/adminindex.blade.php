@section('title', 'Administrator :: '.TITLE_FOR_PAGES.'Areas List')
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul id="breadcrumb" class="breadcrumb">
                    ...
                    <li>
                        <i class="fa fa-building-o"></i> Areas </li>
                    <li class="active">Areas List</li>
                </ul>
                <section class="panel">
                    <header class="panel-heading">
                        Search Area
                        {{ html_entity_decode(HTML::link(HTTP_PATH.'admin/area/admin_add/'.$cityData->slug, '<button type="button" class="btn btn-primary exporttr"><i class="fa fa-plus"></i> Add Area</button>', array('id' => '','class'=>'extrans'), true)) }}
                    </header>
                    <div class="panel-body">
                        {{ View::make('elements.actionMessage')->render() }}
                        {{ Form::open(array('url' => 'admin/area/admin_index/'.$cityData->slug, 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>'form-inline')) }}
                        ...
                        <span class="hint" style="margin:5px 0">Search Area by typing their name</span>
                        <!--                        <div class="form-group align_box">
                                                    <div class="clr"></div>
