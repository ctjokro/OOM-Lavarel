...
if (!$areas->isEmpty()) {
    ...
    {{ Form::open(array('url' => 'admin/area/admin_index/'.$cityData->slug, 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>"form-inline form")) }}
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                                ...
                                foreach ($areas as $area) {
                                    ...
                                    <tr>
                                        <td data-title="Select">
                                            {{ Form::checkbox('id', $area->id,null, array("onclick"=>"javascript:isAllSelect(this.form);",'name'=>"chkRecordId[]")) }}
                                        </td>
                                        <td data-title="Name">
                                            {{ ucwords($area->name); }}
                                        </td>
                                        ...
                                        <td data-title="Created">
                                            {{  date("d M, Y h:i A", strtotime($area->created)) }}</td>
    ...
    <!--                    Number of areas <span class="badge-gray"> </span> - <span class="badge-gray"> </span> out of <span class="badge-gray"></span>-->
                    ...
                    <div class="dataTables_paginate paging_bootstrap pagination">
                        {{ $areas->appends(Request::only('search','from_date','to_date'))->links() }}
                    </div>
                </div>
                <div class="panel-body">
