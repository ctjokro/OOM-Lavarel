...
//        $alllocation[]  = '["'.preg_replace("/[^a-zA-Z0-9\s]/", "", preg_replace('/(?:\r\n|\n)/',"", $valc->address)).' '.$valc->area_name.' '.$valc->city_name.'","<div id=iw-container>'.$img.'<div class=iw-title><a href='.HTTP_PATH.'restaurants/menu/'.$valc->slug.'>'. $valc->first_name.'</a></div></div>","'.$valc->first_name.'"]';
        $alllocation[]  = '["'.preg_replace("/[^a-zA-Z0-9\s]/", "", preg_replace('/(?:\r\n|\n)/',"", $valc->address)).' '.$valc->area_name.' '.$valc->city_name.'","<div id=iw-container><div class=iw-content><div class=iw-subTitle>'.$img.'</div><div class=iw-title><a href='.HTTP_PATH.'restaurants/menu/'.$valc->slug.'>'. $valc->first_name.'</a><div></div>'.preg_replace("/[^a-zA-Z0-9\s]/", "", preg_replace('/(?:\r\n|\n)/',"", $valc->address)).' '.$valc->area_name.' '.$valc->city_name.'</div></div>","'.$valc->first_name.'"]';
