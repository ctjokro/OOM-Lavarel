...
//                         dd($banners); exit;
                        ...
                        <ol class="carousel-indicators">
                            <?php    foreach($banners as $bannersval){
                                if($j == 0){
                                            $classV = "active";
                                        }else{
                                            $classV = "";
                     ...
                     <div class="media">
                         ...
                         <div class="media-body">
                             <h4 class="media-heading">Pay</h4>
                              <p>Pay safely and faster with <b>Paypal !</b></p>
                         </div>
                     </div>
                 </div>
                 <div class="col-md-3 col-sm-6 col-xs-12">
                                ...
                                ?><div class="ekdiv">
                                        ...
                                        <div class="caption">
                                           ...
                                           <div class="uppef dsfdsf_dff">
                                            ...
                                            <p class="content"><a href="{{HTTP_PATH.'restaurants/menu/'.$data->slug}}">{{$data->address}}</a></p>
                                            <p class="address_bok">{{($data->city_name).($data->area_name?", ".$data->area_name:"") }}</p>
                                            <div class="center_button"> <a href="{{HTTP_PATH.'restaurants/menu/'.$data->slug}}" class="btn btn-link" role="button">View Detail</a></div>
                                        </div>
                                    </div>            </div>                            
                                </li>
                                 <?php } ?>
