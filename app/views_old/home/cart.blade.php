    ...
    if (!empty($cart_content)) {
        ...
        <div class="crt_detal">
                        ...
                        <li>
                            ...
                            <div class="hird0">
                                ...
                                <div class="left_main">
                                    ...
                                    <input type="button" value="-" class="but_1 counter_number" data-addon="<?php echo $item_detail['addons'] ?>" data-vaiant="<?php echo $item_detail['variant_type'] ?>"  id_val="{{$item_detail['id']}}"  alt="minus" />
                                    ...
                                    <input type="button" value="+" class="but_2 counter_number" data-addon="<?php echo $item_detail['addons'] ?>" data-vaiant="<?php echo $item_detail['variant_type'] ?>" id_val="{{$item_detail['id']}}"  alt="plus" />
                                </div>
           ...
           <div class = "chus">
                                    <div class = "summary">
                                        <strong>Total</strong>
                                        <p><strong data-total="{{$addonprice}}">{{ App::make("HomeController")->numberformat(array_sum($total) ,2)}}</strong>{{CURR}}</p>
                                    </div>
                                   ...
                                   // Session::put('carttotal', $total);
                                    ...
                                    if (!empty($coupon_detail)) {
                                        ...
                                        <div class = "summary">
                                            ...
                                            <p><strong>- {{ App::make("HomeController")->numberformat($discount ,2)}}</strong>{{CURR}}</p>
            ...
            if ($order) {
                ...
                <div class="add-others">
                    {{html_entity_decode(HTML::link('restaurants/list', "Add more items", array('title' => "Add more items",'class'=>"btn btn-primary"))); }}
                </div>
            <?php } else {
                ?>
        ...
        <div class="add-others centerother">
            <a title="Add items" class="btn btn-primary" href="<?php echo HTTP_PATH; ?>restaurants/list">Add Items</a>
        </div>
        <?php
    }
    ?>
