                        ...
                        <div class="ord_left_bx">
                            ...
                            if (!empty($cart_content)) {
                                ...
                                if ($restro_id) {
                                    ...
                                    if ($pickup_charges) {  //echo "<pre>";print_r($pickup_charges);
                                        if ($pickup_charges->pick_up == 1) {
                                            ...
                                            <div id="choosepick" style="display: <?php echo $choosediv; ?>">
                                                ...
                                                <div class="ore_input_bx fadeoutif" id="pickupoption" style="display: <?php echo isset($pickup) ? "none" : "block"; ?>">
                                                    ...
                                                    <br>
                                                    <input class="btn btn-primary parentcheck"  type="radio" name="pickup_ready" value="0" id="pickup_0"  /><label for="pickup_0"> Deliver at my home</label>
                            ...
                            <script>
                                ...
                                $(document).ready(function () {
                                    $('#pickup_time').timepicker({'defaultTime': 'now', 'forceRoundTime': true, 'timeFormat': 'h:i a', 'step': 10, 'minTime': '<?php echo date('h:i a'); ?>', 'maxTime': '<?php echo $endtime; ?>'});
                                });
                            </script> 
