@section('title', 'Administrator :: '.TITLE_FOR_PAGES.'Add Delivery Charge')
            ...
            <div class="col-lg-12">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::open(array('url' => 'admin/deliverycharge/admin_add', 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>"cmxform form-horizontal tasi-form form")) }}
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                ?>
                                {{ Form::select('from_city_id', $from_cities_array, '1', array('class' => 'required  form-control', 'id'=>'from_city_id')) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                ?>
                                {{ Form::select('to_city_id', $to_cities_array, '1', array('class' => 'required  form-control', 'id'=>'to_city_id')) }}
