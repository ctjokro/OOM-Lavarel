...
<!--                            <div class="form-group ">
                                <label for="name" class="control-label col-lg-2">Linkedin link<span class="require"></span></label>
                                <div class="col-lg-10">
                                    <?php
                                    echo Form::text('linkedin_link', Input::old('linkedin_link'), array('id' => 'linkedin_link', 'autofocus' => true, 'class' => " form-control url"));
                                    ?>
                                </div>
                            </div>
                            <div class="form-group ">
                                <label for="name" class="control-label col-lg-2">Pinterest<span class="require"></span></label>
                                <div class="col-lg-10">
                                    <?php
                                    echo Form::text('pinterest', Input::old('pinterest'), array('id' => 'pinterest', 'autofocus' => true, 'class' => " form-control url"));
                                    ?>
                                </div>
                            </div>-->
