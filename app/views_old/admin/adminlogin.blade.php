...
<div class="container">
    ...
    <div class="website-logos">
        <div class="weblogo-in" >
         ...
         if(file_exists(UPLOAD_LOGO_IMAGE_PATH.SITE_LOGO)){
              ?>
            {{ html_entity_decode(link_to(HTTP_PATH, HTML::image(DISPLAY_LOGO_IMAGE_PATH.SITE_LOGO, "", ['width'=>280]), array('escape' => false,'class'=>"logos"))) }}
            <?php 
         }else{
             ?>
    ...
    <div class="login-wrap">
        ...
        ?>
        <div style="text-align: center;color: #fff" class="_cttv"><span class="_cvv"><a  href="https://cloud8s.com.au/" target="_blank">{{ HTML::image(URL::asset('public/img/front/powered-by-logo.png'), '', array()) }}</a></span></div>
    </div>
    <?php
    echo Form::close();
    ?>
