@section('title', 'Administrator :: '.TITLE_FOR_PAGES.'Sponsorship Payments')
...
<section id="main-content">
    <section class="wrapper">
        <div class="row">
            <div class="col-lg-12">
                <ul id="breadcrumb" class="breadcrumb">
                    ...
                    <li class="active">Sponsorship Payments</li>
                </ul>
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::open(array('url' => 'admin/payments/sponsorships', 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>'form-inline')) }}
        ...
        <div id="middle-content">
            @include('payment/sponsor_ajax_index')
        </div>
    </section>
</section>
@stop