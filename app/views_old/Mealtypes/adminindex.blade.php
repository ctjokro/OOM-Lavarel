@section('title', 'Administrator :: '.TITLE_FOR_PAGES.'Mealtype List')
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul id="breadcrumb" class="breadcrumb">
                    ...
                    <li>
                        <i class="fa fa-coffee"></i> Mealtype
                    </li>
                    <li class="active">Mealtype List</li>
                </ul>
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::open(array('url' => 'admin/mealtype/admin_index', 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>'form-inline')) }}
                        ...
                        <span class="hint" style="margin:5px 0">Search Mealtype by typing their type</span>
