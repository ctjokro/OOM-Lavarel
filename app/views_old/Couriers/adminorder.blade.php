@section('title', 'Administrator :: '.TITLE_FOR_PAGES.'Courier Service Orders List')
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul id="breadcrumb" class="breadcrumb">
                    ...
                    <li>
                        <i class="fa fa-wheelchair"></i> Courier Orders
                    </li>
                    <li class="active"> Courier Orders</li>
                </ul>
                <section class="panel">
                    <header class="panel-heading">
                        Search Courier Orders
                    </header>
                    <div class="panel-body">
                        {{ View::make('elements.actionMessage')->render() }}
                        {{ Form::open(array('url' => 'admin/courier/admin_order', 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>'form-inline')) }}
                        ...
                        <span class="hint" style="margin:5px 0">Search Courier by typing their first name, last name and email or order number</span>
