@section('title', 'Administrator :: '.TITLE_FOR_PAGES.'Couriers List')
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul id="breadcrumb" class="breadcrumb">
                    ...
                    <li class="active">Couriers List</li>
                </ul>
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::open(array('url' => 'admin/courier/admin_index', 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>'form-inline')) }}
                        ...
                        <span class="hint" style="margin:5px 0">Search Courier by typing their first name, last name and email</span>
