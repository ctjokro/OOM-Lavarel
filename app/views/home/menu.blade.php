    ...
    //                            alert(longitude);
            ...
            <div class="listing_bxs_right">
                ...
                <div class="address"> 
                    ...
                    <span class="">{{$caterer->contact}}</span>
                    <div class="faviv">
                        <?php
...
//echo $caterer->id; exit;
                ...
                <div class="open_img open_img_new">
                    ...
                    <?php
                        ...
                        $endbr = explode(',', $caterer->breakfast_time);
                        $startime_1 = array_combine($open_days, $vrrcy);
                        $endtime_2 = array_combine($open_days, $endty);
                        $brtime_3 = array_combine($open_days, $endbr);
                    ?>
...
// check user is enabled to place a review or not  
                ...
                <div class="detail_listing">
                    <ul class="list_menus">
                        <li class="first_blockk">
                            ...
                            <h2>
                                ...
                                foreach(Config::get('constant') as $key => $c)
                                {
                                    if($key == $currency)
                                    {
                                        echo $c.' '.App::make("HomeController")->numberformat($caterer->minimum_order);;
                                    }
                                }
                                ?>
                                <!--                                {{
                        ...
                        $cattype = explode(',',$caterer->catering_type);
                        foreach($cattype as $dr)
                        {
                            if($dr == '5')
                            {  ?>
                            <li class="open_hrs">
                        <!--    <h3>Opening Hours </h3>   breakfast_time -->
                        <?php //echo $cattype; ?>
                            <h3>Breakfast Hours </h3>
                            <!--<span>Current Time : <?php //echo date('y-m-d h:i a',time());?></span>-->
                            ...
                            <div class="see_more">
                                ...
                                <div class="see_date">
                                    <?php
                                		...
                                		$Breakfast_Hours = array('mon' => 'Monday', 'tue' => 'Tuesday', 'wed' => 'Wednesday', 'thu' => 'Thursday', 'fri' => 'Friday', 'sat' => 'Saturday', 'sun' => 'Sunday');
                                		$open_days = explode(",", $caterer->open_days);
                                
                                		//$vrrcy = explode(',', $start_time);
                                		//$endty = explode(',', $end_time);
                                		 
                                		$break = explode(',', $caterer->breakfast_time);
                                		$odd = [];
                                		$even = [];
                                		$start_end_time = [];
                                		$ii = 0;
                                		...
                                		$breaktime = array_combine($open_days, $break); 
                                		$app_timezone = Config::get('app.timezone');
                            		?>
                                    <div class="current_bf_time"></div>
                                </div>
                            </div>
                        </li>
                        ...
                        <!-- lunch -->
                        <?php $cattype = explode(',',$caterer->catering_type);
                        foreach($cattype as $dr)
                        {
                            if($dr == '3') { ?>
                        <li class="open_hrs">
                        <!--    <h3>Opening Hours </h3> -->
                            ...
                            <div class="see_more">
                                ...
                                <div class="see_date">
                                    <?php
                                    //date_default_timezone_set($timezone);
                                    $Lunch_Hour = array('mon' => 'Monday', 'tue' => 'Tuesday', 'wed' => 'Wednesday', 'thu' => 'Thursday', 'fri' => 'Friday', 'sat' => 'Saturday', 'sun' => 'Sunday');
                                    $open_days = explode(",", $caterer->open_days);
                            		...
                            		$odd_l = array();
                                    $even_l = array();
                                    foreach ($start_end_time_l as $k => $v) {
                                        if ($k % 2 == 0) {
                                            $even_l[] = $v;
                                        }
                                        else {
                                    ...
                                    $startime_l = array_combine($open_days,$even_l);
                                    $endtime_l = array_combine($open_days,$odd_l);
                                    ?>
                                    <div class="current_lunch_time"></div>
                                </div>
                            </div>
                        </li>
                        <?php } } ?>
                        ...
                        <!--    <h3>Opening Hours </h3> -->
                            ...
                            <div class="see_more">
                                ...
                                <div class="see_date">
                                    <?php
                                    //date_default_timezone_set($timezone);
                                    $Dinner_Hour = array('mon' => 'Monday', 'tue' => 'Tuesday', 'wed' => 'Wednesday', 'thu' => 'Thursday', 'fri' => 'Friday', 'sat' => 'Saturday', 'sun' => 'Sunday');
                                    
                                     $open_days = explode(",", $caterer->open_days);

                                    $vrrcy1 = explode(',', $caterer->end_time);
                                    $endty1 = explode(',', $end_time);
                                    
                                    
                                    $start_end_time_d = [];
                            		$ii11 = 0;
                            		foreach($vrrcy1 as $b1)
                            		{
                            		   $ttt1 = explode('to', $b1); 
                            		   foreach($ttt1 as $bb1)
                            		   {
                            		       $start_end_time_d[$ii11] = $bb1;
                            		       $ii11++;
                            		   }
                            		}
                            		...
                            		$odd_d = array();
                                    $even_d = array();
                                    foreach ($start_end_time_d as $k => $v) {
                                        if ($k % 2 == 0) {
                                            $even_d[] = $v;
                                        }
                                        else {
                                    ...
                                    $startime_d = array_combine($open_days,$even_d);
                                    $endtime_d = array_combine($open_days,$odd_d);
                                    ?>
                                    <div class="current_dinner_time"></div>
                                </div>
                            </div>
                        </li>
                        <?php } } ?>
        ...
        if (!empty($items)) {
            ...
            <div class="left_new_section">
                <div id="shop_status"></div>
                <div class="col-md-12 col-sm-12 col-xs-12" id="left_new_section">
                    ...
                    <div class="tab_wrap">              
                        <div  class="rj active" id="tab1">
                                ...
                                <div class="cat_menus2">
                                    <ul>
                                        ...
                                        print_r($food_cat);
                                         echo"</pre>";  */
                                        if (!empty($food_cat)) {
                                            foreach ($food_cat as $c) {
                                                ?>
                                                <li class="show_items" id="{{'cls_'.$c->id}}">
                                                    <div class="cuisine-menu">
                                                        <label>{{ucfirst($c->cat_name)}}</label>
                                                        <i class="fa fa-server"></i>
                                                    </div>
                                                </li>
                                                <?php
                            ...
                            <div class="lis_bxx_leftd menu_new_wrap">
                                <?php
                                $cat_types_arr = explode(',', $caterer->catering_type);
                                if (!empty($items)) {
                                    $flag = "";
                                    ...
                                    foreach ($items as $user) {
                                        $cat_types = explode(',',$user->catering_type);
                                        if(!empty(array_intersect($cat_types, $cat_types_arr)))
                                        {
                                     //   $CusId[] = $user->cuisines_id;
                                         $CusId[] = $user->category_id;
                                        ?>
                                        <div class="listing_bxsse">

                                            <?php  if ($flag <> $user->cat_name) { ?>
                                            <?php // if ($flag <> $user->cuisines_name) { ?>
                                           <!--     <a  href="javascript:void(0)" class="shows {{'cls_'.$user->cuisines_id}}">   -->
                                           <?php if(isset($unique_ids[$user->category_id])) { ?>
                                                    
                                                    
                                                <?php } else{ 
                                                $unique_ids[$user->category_id] = 1;
                                                
                                                ?>
                                                
                                                <a  href="javascript:void(0)" class="shows {{'cls_'.$user->category_id}}"> 
                                        ...
                                        if ($user->non_veg == 1) {
                                                    ...
                                                    <div class="coma">
                                                        <div class="love_bx">
                                                            <div class="like_n">
                                                                <?php foreach(Config::get('constant') as $key => $c) { 
                                                                    if($key == $currency)
                                                                        {
                                                                          echo $c.' '.App::make("HomeController")->numberformat($user->price);
                                                                        } 
                                                                        } ?></div>
...
//                                                                    ->orwhere('favorite_menu.session_id', $browser_session_id)
                                ...
                                if ($deals) {
                                    ...
                                    foreach ($deals as $user) {
                                        ...
                                        if ($user->non_veg == 1) {
                                                    ...
                                                    <div class="coma">
                                                        <div class="love_bx">
                                                            <div class="like_n"><?php foreach(Config::get('constant') as $key => $c) { 
                                                                    if($key == $currency)
                                                                        {
                                                                          echo $c.' '.App::make("HomeController")->numberformat($user->price);
                                                                        } 
            ...
            <div class="right_new_section left_menu_right" id="left_menu_right">
            ...
            <?php
           /* if(Session::get('user_type') == '' && Session::get('user_type') != 'Restaurant'){
...
//                                             print_r($record); exit;
                                        if ($record) {
                                            ?>
                                    <?php
                                                if ($record->unique_name) {
                                                    $subdomainVal = $record->unique_name;
                                                } else {
                                                    $subdomainVal = $record->slug;
                                                }
                                                ?>
                                                ...
                                                <div class="slide_image">
                                                    <div class="slide_imgg">
                                                        ...
                                                        if (file_exists(DISPLAY_FULL_PROFILE_IMAGE_PATH . $record->profile_image) and $record->profile_image) {
                                                            ?>
                                                        <a href="{{'http://'.$subdomainVal.'.'.SERVER_PATH}}"><img src="{{ URL::asset('public/assets/timthumb.php?src='.HTTP_PATH.DISPLAY_FULL_PROFILE_IMAGE_PATH.$record->profile_image.'&w=260&h=160&zc=1&q=100') }}" alt="img" class="imggg" /></a>
                                                            ...
                                                            ?>
                                                        <a href="{{'http://'.$subdomainVal.'.'.SERVER_PATH}}"> <img src="{{ URL::asset('public/assets/timthumb.php?src='.HTTP_PATH.'public/img/front/default_restro.png&w=160&h=160&zc=1&q=100') }}" alt="img" class="imggg" /></a>
                                                    ...
                                                    <div class="botm">
                                                        ...
                                                        <div class="tmt_names">
                                                            <a href="{{'http://'.$subdomainVal.'.'.SERVER_PATH}}" class="link-menu_m"> {{ucwords($record->first_name." ".$record->last_name )}}</a>
        ...
        if (variant != "") {
            ...
            splivArr.forEach(function (e) {
                if (e > 0) {
                    ...
                    htmlCont += '<div class="_ttb"><label>' + $("span[data-id-variant='" + e + "']").attr('data-type') + ' (' + $("span[data-id-variant='" + e + "']").attr('data-name-variant') + '):</label> <?php foreach(Config::get('constant') as $key => $c) { 
                                                                    if($key == $currency)
                                                                        {
                                                                          echo $c; } } ?> ' + formatNumber($("span[data-id-variant='" + e + "']").attr('data-price-variant')) + '</div>';
                }
            });
        }
        if (addons != "") {
            ...
            splivArr.forEach(function (e) {
                if (e > 0) {
                    ...
                    htmlCont += '<div class="_ttb"><label>' + $("span[data-id='" + e + "']").attr('data-type') + ' (' + $("span[data-id='" + e + "']").attr('data-name') + '):</label> {{CURR}} ' + formatNumber($("span[data-id='" + e + "']").attr('data-price')) + '</div>';
                }
            });
        }
...
<script>
    ...
    <?php $cattype = explode(',',$caterer->catering_type);
                        foreach($cattype as $dr)
                        {
                            if($dr == '5') { ?>
    //For Breakfast Time
    var current = <?php echo json_encode($Breakfast_Hours); ?>;
    var open_days = <?php echo json_encode($open_days); ?>;
    var even = <?php echo json_encode($even); ?>;
    var odd = <?php echo json_encode($odd); ?>;
    var inc = 0;
    var app_tz = moment.tz.guess();
    var timezone = "<?php echo $timezone; ?>";
    $.each(current, function(i, v){
        if($.inArray(i, open_days) !== -1) {
            var start = even[inc];
            var end = odd[inc];
            var s = moment(start,"YYYY/MM/DD[T]HH:mm:ssZ").tz(app_tz).format("HH:mm:ss");
            var e = moment(end,"YYYY/MM/DD[T]HH:mm:ssZ").tz(app_tz).format("HH:mm:ss");
            var cur_day = moment().tz(app_tz).format("ddd");
            if(cur_day.toLowerCase() == i)
            {
                $('.current_bf_time').append('<span id="dynamic_class" class="date_div active"><label>'+i.toUpperCase()+'</label><b>'+ s +' to '+ e +'</b></span>');    
            }
            else
            {
                $('.current_bf_time').append('<span id="dynamic_class" class="date_div"><label>'+i.toUpperCase()+'</label><b>'+ s +' to '+ e +'</b></span>');
            }
            inc++;
        }
    });
    ...
    <?php $cattype = explode(',',$caterer->catering_type);
                        ...
                        {
                            if($dr == '3') { ?>
    var current = <?php echo json_encode($Lunch_Hour); ?>;
    var open_days = <?php echo json_encode($open_days); ?>;
    var app_tz = moment.tz.guess();
    var timezone = "<?php echo $timezone; ?>";
    var lunch_time = <?php echo json_encode($startime_l); ?>;
    console.log(lunch_time);
    var lunch_time_end = <?php echo json_encode($endtime_l); ?>;
    console.log(lunch_time_end);
    $.each(current, function(i, v){
        if($.inArray(i, open_days) !== -1) {
            var lt = lunch_time[i];
            var end = lunch_time_end[i];
            var s = moment(lt,"YYYY/MM/DD[T]HH:mm:ssZ").tz(app_tz).format("HH:mm:ss");
            var e = moment(end,"YYYY/MM/DD[T]HH:mm:ssZ").tz(app_tz).format("HH:mm:ss");
            var cur_day = moment().tz(app_tz).format("ddd");
            if(cur_day.toLowerCase() == i)
            {
                $('.current_lunch_time').append('<span id="dynamic_class" class="date_div active"><label>'+i.toUpperCase()+'</label><b>'+ s +' to '+ e +'</b></span>');    
            }
            else
            {
                $('.current_lunch_time').append('<span id="dynamic_class" class="date_div"><label>'+i.toUpperCase()+'</label><b>'+ s +' to '+ e +'</b></span>');
            }
        }
    });
    <?php } } ?>
    ...
    <?php $cattype = explode(',',$caterer->catering_type);
                        ...
                        {
                            if($dr == '4') { ?>
    var current = <?php echo json_encode($Dinner_Hour); ?>;
    var open_days = <?php echo json_encode($open_days); ?>;
    var app_tz = moment.tz.guess();
    var timezone = "<?php echo $timezone; ?>";
    var dinner_time_start = <?php echo json_encode($startime_d); ?>;
    var dinner_time = <?php echo json_encode($endtime_d); ?>;
    $.each(current, function(i, v){
        if($.inArray(i, open_days) !== -1) {
            var start = dinner_time_start[i];
            var dt = dinner_time[i];
             var e = moment(dt,"YYYY/MM/DD[T]HH:mm:ssZ").tz(app_tz).format("HH:mm:ss");
            var s = moment(start,"YYYY/MM/DD[T]HH:mm:ssZ").tz(app_tz).format("HH:mm:ss");
            
            var cur_day = moment().tz(app_tz).format("ddd");
            if(cur_day.toLowerCase() == i)
            {
                $('.current_dinner_time').append('<span id="dynamic_class" class="date_div active"><label>'+i.toUpperCase()+'</label><b>'+ s +' to '+ e +'</b></span>');    
            }
            else
            {
                $('.current_dinner_time').append('<span id="dynamic_class" class="date_div"><label>'+i.toUpperCase()+'</label><b>'+ s +' to '+ e +'</b></span>');
            }
        }
    });
    <?php } } ?>
    ...
    console.log(set_unset);
    if(set_unset == 'false')
    {
        $("#tab1").html('');
        $("#tab1").html('<div class="discount_wrap"><div class="_haeding">Menu</div><div class="SAD">No Menu Found.</div></div>')
    }*/
</script>    
@stop
