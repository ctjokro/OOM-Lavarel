                            ...
                            <div class="cart_box">
                                ...
                                if (!empty($cart_content)) {
                                    ...
                                    <div class="crt_detal">
                                        ...
                                        foreach ($new_cat_array as $carter => $items) {
                                            ...
                                            <ul>
                                                ...
                                                foreach ($items as $item_detail) {
                                                    ?>
                                                    <li>
                                                        <p><span>{{$item_detail['name']}} </span></p>
                                                        ...
                                                        <div class="hird0">
                                                            ...
                                                            <div class="left_main">
                                                                ...
                                                                <input type="button" value="-" class="but_1 counter_number"  id_val="{{$item_detail['id']}}"  alt="minus" /><input readonly="readonly" maxlength="3" type="text" value="{{isset($key_array[$item_detail['id']]) ? $key_array[$item_detail['id']] : 0}}" class='<?php echo "preparation_time_" . $item_detail['id']; ?>' />
                                                                <input type="button" value="+" class="but_2 counter_number" id_val="{{$item_detail['id']}}"  alt="plus" />
                                                            </div>
                                                            <div class="maininfocontainer">

                                                                <div class="right_main"><strong>{{$item_detail['price']}} </strong>{{CURR}}</div>
                                                            </div>
                                                        </div>
                                        ...
                                        ?>
                                        <div class = "chus">
                                            <!--<div class = "summary totalbfore">
                                            <strong>Original subtotal</strong>
                                            <p class = "thuert"><strong>14.4</strong>{{CURR}}</p>
                                            </div>
                                            <div class = "summary totalbfore">
                                            <strong>Discount</strong>
                                            <p><strong>14.4</strong>{{CURR}}</p>
                                            </div>
                                            ...
                                            <div class = "summary">
                                                <strong>Total</strong>
                                                <p><strong>{{ App::make("HomeController")->numberformat($cart->total() ,2)}}</strong>{{CURR}}</p>
                                            </div>
