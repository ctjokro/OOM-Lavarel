        ...
        <div class="wrapper">
            ...
            <div class="acc_bar acc_bar_new">
                ...
                <div class="informetion informetion_new">
                    ...
                    <div class="informetion_top change_width">
                                ...
                                <div class="">
                                 <!--   <div class="user-title">Restaurants Details</div> -->   
                                    ...
                                    if (!empty($RestaurantData)) {
                                       if(!empty($RestaurantData->profile_image)){
                                           
                                        ?>
                                        <div class="user-sec-in editsec">
                                            <center>
                                                <!--<img width="300px" height="100px" src="https://www.online-order.menu/dev/uploads/users/<?php echo $RestaurantData->profile_image; ?>" />-->
                                                <img width="300px" height="100px" src="https://www.online-order.menu/uploads/users/<?php echo $RestaurantData->profile_image; ?>" />
                                            </center>
                                        </div>
                                        <?php }  ?>
                                        <div class="">
                                          <!--  <div class="user-sec-left">Name</div>
                                            ...
                                            <center>
                                                {{ $RestaurantData->first_name ? $RestaurantData->first_name.' '.$RestaurantData->last_name:"N/A"; }}
                                            </center>
                                        </div>
                                        <div class="">
                                       <!--     <div class="user-sec-left">Contact Number</div>
                                            ...
                                            <center>
                                                 {{ $RestaurantData->contact ? $RestaurantData->contact:"N/A"; }}
                                            </center>
                                        </div>
                                    <?php } else {
                                        ?>
                                    ...
                                    <div class="">
                                        <center><?php echo date('d M Y h:i A', strtotime($orderData->created)); ?></center>
                                    </div>
                                    
                                    <div class="">
                                        <center>
                                        <div class="">Order Number: <?php echo $orderData->order_number; ?></div>
                                        </center>
                                    </div>
                                    
                                    
                                     <div class="" style="">
                                        <p style="border-bottom:2px dotted;"> Note:</p>
                            ...
                            if ($cartItems) {
                                ...
                                <div class="form-group">
                                    ...
                                    <!--    <div class="order-title user-title">Items Details</div>  -->
                                        <div class="order-table-sec editsec">
...
//                                                $sub_total = $cartData->base_price * $cartData->quantity;
                                                ...
                                                <div class="order-table-middel">
                                                    <div class="order-table-middel-in editsec">
                                                        <div class="menucmtilet text_color">
                                                            <?php echo $menuData->item_name; ?> (<?php echo $cartData->quantity; ?>)
                                                        </div>
                                                            ...
                                                            if(isset($cartData->variant_id)){
                                                                ...
                                                                if($explode){
                                                                    foreach($explode as $explodeVal){
                                                                         ...
                                                                         ?> <div class="menucmt"><span class="sumss"><i class="fa fa-tag"></i> Variant ({{$addonV->name}}) </span> <span class="pricev"><?php foreach(Config::get('constant') as $key => $c) { 
                                                                    if($key == $currency)
                                                                        {
                                                                          echo $c; }}?> <strong>{{$addonV->price}} </strong></span></div><?php
                                                                         }
                                                                    }
                                                                }
                                                            }
                                                                ...
                                                                if($explode){
                                                                    foreach($explode as $explodeVal){
                                                                         ...
                                                                         if($addonV){
                                                                          ...
                                                                          $addonTotal[] = $addonprice;
                                                                         ?> <div class="menucmt"><span class="sumss"><i class="fa fa-tag"></i> Add-on ({{$addonV->addon_name}}) </span> <span class="pricev"><?php foreach(Config::get('constant') as $key => $c) { 
                                                                    if($key == $currency)
                                                                        {
                                                                          echo $c; }}?> <strong>{{$addonV->addon_price}} </strong></span></div><?php
                                                                         }
                                                                    }
                                                                }
                                                            }
                                                    ...
                                                    <div class="order-table-end-in editsec" style="border-right:0px;">&nbsp;</div>
                                                    <div class="order-table-end-in editsec" style="border-right:0px;">&nbsp;</div>
                                                  <!--  <div class="order-table-middel-in"><?php echo App::make("HomeController")->numberformat($addonprice, 2) ; ?></div>
                                                    ...
                                                    <div class="order-table-middel-in editsec"><?php foreach(Config::get('constant') as $key => $c) { 
                                                                    if($key == $currency)
                                                                        {
                                                                          echo $c; }}?><?php echo App::make("HomeController")->numberformat($addonprice, 2) ; ?></div>
                                            ...
                                            <div class="order-table-end">
                                                <div class="order-table-end-in editsec text_color" style="border-right:0px;">Total</div>
                                                <div class="order-table-end-in editsec text_color" style="border-right:0px;">&nbsp;</div>
                                                <div class="order-table-end-in editsec text_color">&nbsp;</div>
                                                <div class="order-table-middel-in-g editsec text_color"><?php foreach(Config::get('constant') as $key => $c) { 
                                                                    if($key == $currency)
                                                                        {
                                                                          echo $c; }}?> <?php echo App::make("HomeController")->numberformat($gTotal, 2) ; ?></div>
                                            </div>
                                            <?php
                                         ...
                                         if (!empty($orderData->discount)) {
                                           ...
                                           //  if(count($ordersc) == 1){
                                                ...
                                                ?>
                                                <div class="order-table-end">
                                                    <div class="order-table-end-in editsec" style="border-right:0px;">Discount (-)</div>
                                                    <div class="order-table-end-in editsec" style="border-right:0px;">&nbsp;</div>
                                                    <div class="order-table-end-in editsec">&nbsp;</div>
                                                    <div class="order-table-middel-in-g editsec"> <?php foreach(Config::get('constant') as $key => $c) { 
                                                                    if($key == $currency)
                                                                        {
                                                                          echo $c; }}?><?php echo App::make("HomeController")->numberformat($minus, 2) ; ?></div>
                                                </div>
                                         <?php  }  ?>
                                            <?php
                                           if (!empty($orderData->tax)) {
                                              // $ordersc = explode(',',$orderData->order_id);
                                                ...
                                                ?>
                                                <div class="order-table-end">
                                                    <div class="order-table-end-in editsec" style="border-right:0px;">Tax</div>
                                                    <div class="order-table-end-in editsec" style="border-right:0px;">&nbsp;</div>
                                                    <div class="order-table-end-in editsec">&nbsp;</div>
                                                    <div class="order-table-middel-in-g editsec"><?php foreach(Config::get('constant') as $key => $c) { 
                                                                    if($key == $currency)
                                                                        {
                                                                          echo $c; }}?><?php echo App::make("HomeController")->numberformat($tax, 2) ; ?></div>
                                                </div>
                                            <?php }  ?>
                                            ...
                                            if (!empty($orderData->delivery_charge)) {
                                                ...
                                                ?>
                                                <div class="order-table-end">
                                                    <div class="order-table-end-in editsec" style="border-right:0px;">Delivery Charge (<?php echo $orderData->delivery_type; ?>)</div>
                                                    <div class="order-table-end-in editsec" style="border-right:0px;">&nbsp;</div>
                                                    <div class="order-table-end-in editsec">&nbsp;</div>
                                                    <div class="order-table-middel-in-g editsec"><?php foreach(Config::get('constant') as $key => $c) { 
                                                                    if($key == $currency)
                                                                        {
                                                                          echo $c; }}?> <?php echo App::make("HomeController")->numberformat($orderData->delivery_charge, 2) ; ?></div>
                                                </div>
                                            <?php }  ?>
                                            <?php $gTotal = $gTotal; ?>
                                            <?php if($orderData->payby_wallet){ ?>
                                             <div class="order-table-end">
                                                <div class="order-table-end-in editsec" style="border-right:0px;">Amount By wallet</div>
                                                <div class="order-table-end-in editsec" style="border-right:0px;">&nbsp;</div>
                                                <div class="order-table-end-in editsec">&nbsp;</div>
                                                <div class="order-table-middel-in-g editsec"><?php foreach(Config::get('constant') as $key => $c) { 
                                                                    if($key == $currency)
                                                                        {
                                                                          echo $c; }}?> <?php echo App::make("HomeController")->numberformat($orderData->payby_wallet, 2) ; ?></div>
                                            </div>
                                            <?php } ?>
                                            
                                            <div class="order-table-end">
                                                <div class="order-table-end-in editsec text_color" style="border-right:0px;">Grand Total</div>
                                                <div class="order-table-end-in editsec" style="border-right:0px;">&nbsp;</div>
                                                <div class="order-table-end-in editsec">&nbsp;</div>
                                                <div class="order-table-middel-in-g editsec text_color"><?php foreach(Config::get('constant') as $key => $c) { 
                                                                    if($key == $currency)
                            ...
                            <!-- order status new -->        
                            <div class="" style="">
                                        <center><h1 style="border-bottom:2px dotted;">ORDER HAS BEEN <?php echo strtoupper($orderData->status); ?></center></h1>
                                      
                                    </div>
                            <?php  
                          $city =  DB::table('cities')->where('id',$userData->city)->select('name')->first();
                          $cityname = (isset($city->name))?$city->name:' ';
                          $area =  DB::table('areas')->where('id',$userData->area)->select('name')->first();
                          $areaname = (isset($area->name))?$area->name:' ';
                            ?>        
                             <!-- customer new --> 
                             <div class="">
                              <p>Customer Detials</p>   
                              <p>{{ $cityname }} {{ $areaname }}</p>
