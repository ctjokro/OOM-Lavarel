...
//                                                    $total[] = $sub_total;
                                    ...
                                    $total[] = $addonprice;
                                                        ...
                                                        <div class="order-table-middel-in"><?php 
                                                        foreach(Config::get('constant') as $key => $c)
                                                        {
                                                            if($key == $currency)
                                                            {
                                                                echo $c.' '.App::make("HomeController")->numberformat($addonprice, 2);
                                                            }
                                                        }
                                                        //echo App::make("HomeController")->numberformat($addonprice, 2); 
                                                        ?></div>
                                                ...
                                                <div class="order-table-end">
                                                    ...
                                                    <div class="order-table-middel-in-g"><?php 
                                                    foreach(Config::get('constant') as $key => $c)
                                                        {
                                                            if($key == $currency)
                                                            {
                                                                echo $c.' '.App::make("HomeController")->numberformat($gTotal, 2);
                                                            }
                                                        }
                                                    //echo App::make("HomeController")->numberformat($gTotal, 2); ?></div>
                                                </div>
                                                <?php
                                                if (!empty($orderData->discount)) {
                                                    ...
                                                    <div class="order-table-end">
                                                        ...
                                                        foreach(Config::get('constant') as $key => $c)
                                                        {
                                                            if($key == $currency)
                                                            {
                                                                echo $c.' '.App::make("HomeController")->numberformat($minus, 2);
                                                            }
                                                        }
                                                        //echo App::make("HomeController")->numberformat($minus, 2); ?></div>
                                                    </div>
                                                <?php } ?>
                                                <?php
                                                if (!empty($orderData->tax)) {
                                                    ...
                                                    <div class="order-table-end">
                                                        ...
                                                        foreach(Config::get('constant') as $key => $c)
                                                        {
                                                            if($key == $currency)
                                                            {
                                                                echo $c.' '.App::make("HomeController")->numberformat($tax, 2);
                                                            }
                                                        }
                                                        //echo App::make("HomeController")->numberformat($tax, 2); 
                                                        ?></div>
                                                    </div>
                                                <?php } ?>
                                                ...
                                                if (!empty($orderData->delivery_charge)) {
                                                    ...
                                                    <div class="order-table-end">
                                                        ...
                                                        foreach(Config::get('constant') as $key => $c)
                                                        {
                                                            if($key == $currency)
                                                            {
                                                                echo $c.' '.App::make("HomeController")->numberformat($orderData->delivery_charge, 2);
                                                            }
                                                        }
                                                        //echo App::make("HomeController")->numberformat($orderData->delivery_charge, 2); ?></div>
                                                    </div>
                                                <?php } ?>
                                                <?php /*
                                                ...
                                                <div class="order-table-end">
                                                    ...
                                                    //echo App::make("HomeController")->numberformat($gTotal, 2); 
                                                    ?></div>
                                                </div>
                                            </div>
                                        </div>
