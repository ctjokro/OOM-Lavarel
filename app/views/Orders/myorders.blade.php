                                                ...
                                                <div data-title="Action" class="td_tables2">
                                                    <div class="actions">
                                                        ...
                                                        if($data->is_review == 0 && $data->status == 'Delivered'){
                                                            echo html_entity_decode(HTML::link('/restaurants/reviews/' . $data->restroslug . '/' . $data->slug, '<i class="fa fa-star"></i>', array('class' => 'btn btn-primary btn-xs', 'title' => 'Place reviews')));
                                                        }
