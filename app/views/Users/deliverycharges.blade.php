                ...
                <div class="informetion informetion_new">
                    <div class="informetion_top">
                        ...
                        <div class="pery">
							...
							<label for="name" class="control-label col-lg-2">Order Available by<span class="require">*</span></label>  
							<div class="col-lg-10">
                            <select name="pick_up_method" class="required form-control ">
							<option value="1" {{($detail->pick_up==1)?'selected':''}}>Pickup</option>
							<option value="2" {{($detail->pick_up==2)?'selected':''}}>Delivery</option>
							<option value="3" {{($detail->pick_up==3)?'selected':''}}>Pickup and Delivery</option>
                            </select>   
							</div>     
							</div> 
                          ...
                          <!--  <div class="label">Pickup Avaliable <span class="require">*</span></div>
                            ...
                            <div class="form-group ">
                                <label for="name" class="control-label col-lg-2">Vespa Delivery Price (<?php 
                                ...
                                <div class="col-lg-10">
                                    <?php
                                    echo Form::text('normal', Input::old('normal'), array('id' => 'normal', 'autofocus' => true, 'class' => "required form-control number", 'min' => "0"));
                                    ?>
                                </div>
                            </div>
                            <div class="form-group ">
                                <label for="name" class="control-label col-lg-2">Car Delivery Price (<?php 
                                    foreach(Config::get('constant') as $key => $c)
                                    {
                                        if($key == $currency)
                                        {
                                ...
                                <div class="col-lg-10">
                                    <?php
                                    echo Form::text('advance', Input::old('advance'), array('id' => 'advance', 'autofocus' => true, 'class' => "required form-control number", 'min' => "0"));
                                    ?>
                                </div>
                            </div>
                             <div class="form-group ">
                                <label for="name" class="control-label col-lg-2">Delivery Charge Limit (<?php 
                                    foreach(Config::get('constant') as $key => $c)
                                    {
                                        if($key == $currency)
                                        {
                                ...
                                <div class="col-lg-10">
                                    <?php
                                    echo Form::text('delivery_charge_limit', Input::old('delivery_charge_limit'), array('id' => 'delivery_charge_limit', 'autofocus' => true, 'class' => "required form-control number", 'min' => "0"));
                                    ?>
