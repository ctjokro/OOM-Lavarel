                                ...
                                <div class="in_upt">
                                    ...
                                    if (!empty($cat)) {
                                        foreach ($cat as $key => $val)
                                            $category[$val->id] = $val->cat_name;
                                    }
                                    ?>
                                    {{ Form::select('category', $category, Input::old("category"), array('class' => 'form-control required', 'id'=>'category')) }}
                                </div>
                            </div>
