            ...
            <div class="col-lg-12">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <!--<div class="form-group">
                            {{ HTML::decode(Form::label('unique_name', "Unique Name",array('class'=>"control-label col-lg-2"))) }}
                            <div class="col-lg-10" style="margin-top: 7px">
                                {{ $detail->unique_name }}
                            </div>
                        </div>-->
                        <div class="form-group">
                            ...
                            <div class="col-lg-10" style="margin-top: 7px">
                                <?php echo Form::text('unique_name', Input::old('unique_name'), array('class' => 'required form-control')); ?>
                                <!--{{ $detail->unique_name }}-->
                            </div>
                        </div>
                        <div class="form-group">
...
<!--                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <select class="required form-control valid" name="category" required>
                                ...
                                if (!empty($cat)) {
                                    foreach ($cat as $key => $val) {
                                        ?>
                                        <option value="{{$val->id}}" <?php if($val->id == $detail->food_category){ echo "selected"; } ?> >{{  ucfirst($val->cat_name) }} </option> 
