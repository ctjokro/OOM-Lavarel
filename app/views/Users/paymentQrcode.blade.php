               ...
               @include('elements/oderc_menu')
                ...
                <div class="informetion informetion_new"><div class="informetion_top">
                        ...
                        <div class="pery">
                            ...
                            {{ Form::open(array('url' => '/order/paymentQrcode', 'method' => 'post', 'id' => 'myform', 'files' => true,'class'=>"cmxform form-horizontal tasi-form form")) }}
                            ...
                            if (!Input::hasFile('payment_qrcode')) {
                                ...
                                <div class="form_group">
                                    {{  Form::label('old_image', 'Current Payment Qrcode Image',array('class'=>"control-label col-lg-2")) }}
                                    <div class="in_upt">
                                        <div class="in_upt_img">
                                            <?php if (file_exists(UPLOAD_FULL_PROFILE_IMAGE_PATH . '/' . $userData->payment_qrcode) && $userData->payment_qrcode != "") { ?>
                                                {{ HTML::image(DISPLAY_FULL_PROFILE_IMAGE_PATH.$userData->payment_qrcode, '') }}
                                ...
                                <div class="form_group">
                                    {{ HTML::decode(Form::label('name', "Payment Qrcode <span class='require'>*</span>",array('class'=>"control-label col-lg-2"))) }}
                                    <div class="in_upt">
                                        {{ Form::file('payment_qrcode', array('class'=>"required",'id'=>"payment_qrcode")); }}
