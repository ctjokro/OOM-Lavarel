                ...
                <div class="cta_area cta_area_nome">
                    <div class="catr_link catr_link_left">
                        <form name="payment_form" action="<?php echo PAYPAL_URL; ?>" method="post" id="payment_form">
                            ...
                            <input type="hidden" name="item_name" value="Payment for upgrade to featured on <?php echo SITE_TITLE; ?>"/>
                            <input type="hidden" name="amount" value="<?php echo $total; ?>">
                            <input type="hidden" name="no_shipping" value="0">
                            <input type="hidden" name="lc" value="EN"/>
                            <input type="hidden" name="return" value="<?php echo HTTP_PATH . 'user/success/' . $id; ?> "/>
                            <input type="hidden" name="cancel_return" value="<?php echo HTTP_PATH . 'user/cancel/' . $id; ?>"/>
                            <input type="hidden" name="notify_url" value="<?php echo HTTP_PATH . 'user/notify/' . $id; ?>"/>
