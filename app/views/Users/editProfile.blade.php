                ...
                <div class="informetion informetion_new">
                    <div class="informetion_top">
                        ...
                        <div class="pery">
                            ...
                            <div class="form_group">
                                {{ HTML::decode(Form::label('postal_code', "Postal Code <span class='require'>*</span>",array('class'=>"control-label col-lg-2"))) }}
                                <div class="in_upt">
                                    {{ Form::text('postal_code', Input::old('postal_code'), array('class' => 'required form-control', 'maxlength'=>16)) }}
                                </div>
                            </div>
                            <?php if ($userData->user_type <> 'Courier') { ?>
                                ...
                                <div class="form_group">
                                    ...
                                    <div class="in_upt">
                                        {{ Form::text('country', Input::old('country'), array('class' => 'required form-control', 'maxlength'=>16)) }}
                                    </div>
                                </div>
                                <div class="form_group">
                            ...
                            <!--<div class="form_group">
                                {{ HTML::decode(Form::label('name', "Logo <span class='require'>*</span>",array('class'=>"control-label col-lg-2"))) }}
                                <div class="in_upt">
                                    {{ Form::file('restaurant_logo', Input::old('restaurant_logo'), array('class'=>"required",'id'=>"restaurant_logo")); }}
