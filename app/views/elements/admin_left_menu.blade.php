        ...
        <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub" style="{{Request::is('admin/restaurants*') ? 'display: block;' : '' }}">
                    ...
                    <li class="{{ Request::is('admin/restaurants/addcategory') ? 'active' : '' }}">{{ link_to('/admin/restaurants/addcategory', 'Add Food Category', ['escape' => false]) }}</li>
                    <li class="{{ Request::is('admin/restaurants/categorylist') ? 'active' : '' }}">{{ link_to('/admin/restaurants/categorylist', 'Food Category List', ['escape' => false]) }}</li>
                </ul>
            </li>
            <li class="sub-menu">
