        ...
        <section id="container" >
            ...
            <footer class="site-footer">
                ...
                <div class="fgdf" style="text-align: center;color: #fff" class="_cttv"><span class="_cvv">
                        <a  href="https://cloud8s.com.au/" target="_blank">{{ HTML::image(URL::asset('public/img/front/powered-by-logo.png'), '', array()) }}</a>
<!--                        {{  html_entity_decode(link_to('', '', array('escape' => false,'target'=>'_blank','style'=>'color:#009ddc'))) }}-->
                    </span></div>
