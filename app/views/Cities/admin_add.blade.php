            ...
            <div class="col-lg-12">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::open(array('url' => 'admin/cities/admin_add', 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>"cmxform form-horizontal tasi-form form")) }}
                        <div class="form-group">
                            {{ HTML::decode(Form::label('name', "City Name <span class='require'>*</span>",array('class'=>"control-label col-lg-2"))) }}
                            <div class="col-lg-10">
