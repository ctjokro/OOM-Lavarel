...
//                                                $sub_total = $cartData->base_price * $cartData->quantity;
                                                ...
                                                <div class="order-table-middel">
                                                  ...
                                                  <!--  <div class="order-table-middel-in"><?php echo App::make("HomeController")->numberformat($addonprice, 2) ; ?></div>
                                                    ...
                                                    <div class="order-table-middel-in editsec"><?php echo App::make("HomeController")->numberformat($addonprice, 2) ; ?></div>
                                            ...
                                            <div class="order-table-end">
                                                ...
                                                <div class="order-table-middel-in-g editsec text_color"><?php echo App::make("HomeController")->numberformat($gTotal, 2) ; ?></div>
                                            </div>
                                            <?php
                                         ...
                                         if (!empty($orderData->discount)) {
                                           ...
                                           //  if(count($ordersc) == 1){
                                                ...
                                                <div class="order-table-end">
                                                    ...
                                                    <div class="order-table-middel-in-g editsec"> <?php echo App::make("HomeController")->numberformat($minus, 2) ; ?></div>
                                                </div>
                                         <?php  }  ?>
                                            <?php
                                           if (!empty($orderData->tax)) {
                                              // $ordersc = explode(',',$orderData->order_id);
                                                ...
                                                <div class="order-table-end">
                                                    ...
                                                    <div class="order-table-end-in editsec" style="border-right:0px;">&nbsp;</div>
                                                    <div class="order-table-end-in editsec">&nbsp;</div>
                                                    <div class="order-table-middel-in-g editsec"><?php echo App::make("HomeController")->numberformat($tax, 2) ; ?></div>
                                                </div>
                                            <?php }  ?>
                                            ...
                                            if (!empty($orderData->delivery_charge)) {
                                                ...
                                                <div class="order-table-end">
                                                    ...
                                                    <div class="order-table-end-in editsec" style="border-right:0px;">&nbsp;</div>
                                                    <div class="order-table-end-in editsec">&nbsp;</div>
                                                    <div class="order-table-middel-in-g editsec"><?php echo App::make("HomeController")->numberformat($orderData->delivery_charge, 2) ; ?></div>
                                                </div>
                                            <?php }  ?>
                                            <?php $gTotal = $gTotal; ?>
                                            <?php if($orderData->payby_wallet){ ?>
                                             <div class="order-table-end">
                                                ...
                                                <div class="order-table-end-in editsec" style="border-right:0px;">&nbsp;</div>
                                                <div class="order-table-end-in editsec">&nbsp;</div>
                                                <div class="order-table-middel-in-g editsec"><?php echo App::make("HomeController")->numberformat($orderData->payby_wallet, 2) ; ?></div>
                                            </div>
                                            <?php } ?>
