                        ...
                        <table class="table table-bordered table-striped table-condensed cf">
                            <thead class="cf">
                                <tr>
                                    ...
                                    <th class=" enable-sort" sort_type="" field="tbl_pages.first_name">Category</th>
                                        ...
                                        <td data-title="Action">
                                            <?php
                                             if ($page->category != 'Main') { 
                                                if (!$page->status)
                                                    echo html_entity_decode(HTML::link('admin/page/Admin_activepage/' . $page->slug, '<i class="fa fa-check"></i>', array('class' => 'btn btn-success btn-xs action-list', 'title' => "Active",'onclick'=>"return confirmAction('active');")));
                                                else
                                                    echo html_entity_decode(HTML::link('admin/page/Admin_deactivepage/' . $page->slug, '<i class="fa fa-check"></i>', array('class' => 'btn btn-danger btn-xs action-list', 'title' => "Deactive",'onclick'=>"return confirmAction('deactive');")));
                                            }
