@section('title', 'Administrator :: '.TITLE_FOR_PAGES.'Delivery Charge List')
...
<section id="main-content">
    <section class="wrapper">
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul id="breadcrumb" class="breadcrumb">
                    ...
                    <li>
                        <i class="fa fa-money"></i> Delivery Charges </li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::open(array('url' => 'admin/deliverycharge/admin_index', 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>'form-inline')) }}
                        ...
                        <span class="hint" style="margin:5px 0">Search Delivery Charges by typing their city name</span>
                        <!--                        <div class="form-group align_box">
                                                    <div class="clr"></div>
        ...
        <div id="middle-content">
            @include('Deliverycharge/ajax_index')
        </div>
    </section>
</section>
